...
export default function Quick10Selection() {
  ...
  const handleStartQuick10 = (courseId: string) => {
    router.push(`/quick10/questions?courseId=${courseId}`);
  };
  ...
  return (
    <div className="container mx-auto min-h-screen space-y-6 p-4 md:p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Quick 10 Mode</h1>
                ...
                <Card key={course.id}>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Take a quick 10 question quiz for {course.name}.
                    </p>
                    <Button 
                      className="w-full" 
                      onClick={() => handleStartQuick10(course.id)}
                    >
                      Start Quick 10
                    </Button>
                  </CardContent>
